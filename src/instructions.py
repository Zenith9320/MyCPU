...
instruction_table = [
    ...
    ('add', OP_R_TYPE, 0x0, 0, ALUOp.ADD, Op1Type.RS1, Op2Type.RS2, MemOp.NONE,
     MemWidth.WORD, Bits(1)(0), IF_WB.YES, BranchType.NO_BRANCH, ImmType.R),
    ...
    ('addi', OP_I_TYPE, 0x0, None, ALUOp.ADD, Op1Type.RS1, Op2Type.IMM, MemOp.NONE,
     MemWidth.WORD, Bits(1)(0), IF_WB.YES, BranchType.NO_BRANCH, ImmType.I),
    ...
    ('lb', OP_LOAD, 0x0, None, ALUOp.ADD, Op1Type.RS1, Op2Type.IMM, MemOp.LOAD,
     MemWidth.BYTE, MemSign.SIGNED, IF_WB.YES, BranchType.NO_BRANCH, ImmType.I),
    ('lh', OP_LOAD, 0x1, None, ALUOp.ADD, Op1Type.RS1, Op2Type.IMM, MemOp.LOAD,
     MemWidth.HALF, MemSign.SIGNED, IF_WB.YES, BranchType.NO_BRANCH, ImmType.I),
    ('lw', OP_LOAD, 0x2, None, ALUOp.ADD, Op1Type.RS1, Op2Type.IMM, MemOp.LOAD,
     MemWidth.WORD, MemSign.SIGNED, IF_WB.YES, BranchType.NO_BRANCH, ImmType.I),
    ('lbu', OP_LOAD, 0x4, None, ALUOp.ADD, Op1Type.RS1, Op2Type.IMM, MemOp.LOAD,
     MemWidth.BYTE, MemSign.UNSIGNED, IF_WB.YES, BranchType.NO_BRANCH, ImmType.I),
    ('lhu', OP_LOAD, 0x5, None, ALUOp.ADD, Op1Type.RS1, Op2Type.IMM, MemOp.LOAD,
     MemWidth.HALF, MemSign.UNSIGNED, IF_WB.YES, BranchType.NO_BRANCH, ImmType.I),

    # SInst
    ('sb', OP_STORE, 0x0, None, ALUOp.ADD, Op1Type.RS1, Op2Type.IMM, MemOp.STORE,
     MemWidth.BYTE, Bits(1)(0), IF_WB.NO, BranchType.NO_BRANCH, ImmType.S),
    ('sh', OP_STORE, 0x1, None, ALUOp.ADD, Op1Type.RS1, Op2Type.IMM, MemOp.STORE,
     MemWidth.HALF, Bits(1)(0), IF_WB.NO, BranchType.NO_BRANCH, ImmType.S),
    ('sw', OP_STORE, 0x2, None, ALUOp.ADD, Op1Type.RS1, Op2Type.IMM, MemOp.STORE,
     MemWidth.WORD, Bits(1)(0), IF_WB.NO, BranchType.NO_BRANCH, ImmType.S),
    ...
    ('lui', OP_LUI, None, None, ALUOp.ADD, Op1Type.ZERO, Op2Type.IMM, MemOp.NONE,
     MemWidth.WORD, Bits(1)(0), IF_WB.YES, BranchType.NO_BRANCH, ImmType.U),
    ...
    ('ecall', OP_SYSTEM, 0x0, 0, ALUOp.SYS, Op1Type.RS1, Op2Type.IMM, MemOp.NONE,
     MemWidth.WORD, Bits(1)(0), IF_WB.NO, BranchType.NO_BRANCH, ImmType.I),
